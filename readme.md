...
<br />
<div align="center">
  <a href="https://github.com/Rambo9223/Nextjs-CV">
    <img src="/static/images/About.png" alt="Logo">
  </a>

<h3 align="center">Next.JS CV/Portfolio</h3>

  <p align="center">
    project_description
    <br />
    <a href="https://github.com/Rambo9223/Nextjs-CV/tree/main"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://nextjs-cv-sage.vercel.app/">View Deployment</a>
    ·
  </p>
</div>
...
This is my CV/Portfolio page made in NextJS. You can find out all about my educational background and see my most up to date projects.   
...
Open the terminal or VSCode and navigate to the directory that contains the files using cd
  ...
  Type in to the terminal
    ```
    npm install (Once dependecies install)

    npm run dev
    ```
then enter, the required packages should install and once compiled you will be able to use the app on your browser at http://localhost:3000/ and http://localhost:3000/test_routing
...
- As my skills in coding with the NextJS framework improve, refine UI & display.
...
Project Link: [https://github.com/github_username/repo_name](https://github.com/Rambo9223/Nextjs-CV)
